...
def setup_gui(queue):
    ...
    root.geometry("1000x600")  # Adjusted size to accommodate list and other elements

    # Frame for time and runtime on the same line
    ...
    def toggle_maintenance():
        ...
        if maintenance_mode:
            maintenance_button.config(bg='red', text='Disable Maintenance')
        else:
            maintenance_button.config(bg='gray', text='Enable Maintenance')
