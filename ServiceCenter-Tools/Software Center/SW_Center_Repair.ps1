...
Tested On : 03-31-25
This script will copy over files for Software Center Uninstallation and Installation") | DarkRed

## Description
Write-Output ("Description:
This script will copy over files for Software Center Uninstallation and Installation It will then remove and reinstall software center") | Green
