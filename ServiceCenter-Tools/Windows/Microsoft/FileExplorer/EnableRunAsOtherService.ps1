## This script will enable the Service "Seconday Login" which can affect a users ability to "run as other user"
...
This script will set the service of Secondar Logon to be enabled and automatic
Associated Resource $File") | DarkRed

## Description
Write-Output ("Description
his script will set the service of Secondar Logon to be enabled and automatic") | Green
...
if ($service -ne $null) {
    ...
    Write-Output "The 'Secondary Logon' service has been set to start automatically and is now running." | Green
} else {
