...
$File = "Acrobat_DC_Reader.zip"
$MainInstaller = "Acrobat_DC_Reader_install.bat"
$MainUnInstaller = "Acrobat_DC_Reader_uninstall.bat"
...
This script will Install Adobe DC Reader
Associated Resource $File") | DarkRed

## Description
Write-Output ("Description
This script will Uninstall Adobe with AcroCleaner if it exists then it will Install Adobe DC Reader") | Green
...
Start-Process "C:\temp\Acrobat_DC_Reader\$MainUnInstaller" -wait
Write-Output "Finished $MainUnInstaller" | Green
## Uninstall Completed

## Starting Installation
Write-Output "Starting $MainInstaller" | Green
Start-Process "C:\temp\Acrobat_DC_Reader\$MainInstaller" -wait
